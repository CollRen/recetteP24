        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap text-left lg:text-left">
                <div class="w-full lg:w-6/12 px-4">
                    <h4 class="text-3xl fonat-semibold text-clr-pri1">@lang('Have Comments')&nbsp;?</h4>
                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="flex flex-wrap items-top mb-6">
                        <div class="w-full lg:w-4/12 px-4 ml-auto">
                            <span class="block uppercase text-clr-pri2 text-sm font-semibold mb-2">@lang('Usefull Links')</span>
                        ...
                        <div class="w-full lg:w-4/12 px-4">
                            <span class="block uppercase text-clr-pri2 text-sm font-semibold mb-2">Ressources</span>
                            <ul class="list-unstyled">
                                <li>
                                    <a class="text-clr-pri1 hover:text-clr-pri1 font-semibold block pb-2 text-sm"
                                        href="#">@lang('Termes')</a>
            ...
            <div class="flex flex-wrap items-center md:justify-between justify-center">
                <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                    <div class="text-sm text-clr-pri2 font-semibold py-1">
                        @lang('Copyright') © <span id="get-current-year">@php
                            echo $annee;
                        @endphp</span><a
                            href="#"
                            class="text-clr-pri2 hover:text-gray-800" target="_blank"> @lang('Create by')
