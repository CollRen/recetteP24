                ...
                <div class="flex-auto p-6">
                    <form  method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" id="ingredient_en" name="ingredient_en" value="{{ old('ingredient_en', $ingredient['en']) }}">
                        </div>
                        <div class="mb-3">
                            <label for="ingredient_fr" class="form-label">Ingredient in French</label>
                            <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" id="ingredient_fr" name="ingredient_fr" value="{{ old('ingredient_fr', $ingredient['fr']) }}">
                        </div>
